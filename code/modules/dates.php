...
function markDays(&$academicYear, $course)
{
    $markedDays =
        [
            1 => [
                ['from' => ['day' => 1, 'month' => 1, 'endYear' => true],
                    'to' => ['day' => 25, 'month' => 1, 'endYear' => true], 'type' => 'session'],
                ['from' => ['day' => 11, 'month' => 6, 'endYear' => true],
                    'to' => ['day' => 2, 'month' => 7, 'endYear' => true], 'type' => 'session'],
                ['from' => ['day' => 26, 'month' => 1, 'endYear' => true],
                    'to' => ['day' => 8, 'month' => 2, 'endYear' => true], 'type' => 'holidays'],
                ['from' => ['day' => 3, 'month' => 7, 'endYear' => true],
                    'to' => ['day' => 31, 'month' => 8, 'endYear' => true], 'type' => 'holidays']],
            2 => [
                ['from' => ['day' => 1, 'month' => 1, 'endYear' => true],
                    'to' => ['day' => 25, 'month' => 1, 'endYear' => true], 'type' => 'session'],
                ['from' => ['day' => 11, 'month' => 6, 'endYear' => true],
                ...
                ['from' => ['day' => 3, 'month' => 7, 'endYear' => true],
                    'to' => ['day' => 31, 'month' => 8, 'endYear' => true], 'type' => 'holidays']],
            3 => [
                ['from' => ['day' => 22, 'month' => 12, 'endYear' => false],
                    'to' => ['day' => 11, 'month' => 1, 'endYear' => true], 'type' => 'session'],
                ['from' => ['day' => 19, 'month' => 5, 'endYear' => true],
                    'to' => ['day' => 7, 'month' => 6, 'endYear' => true], 'type' => 'session'],
                ['from' => ['day' => 12, 'month' => 1, 'endYear' => true],
                    'to' => ['day' => 25, 'month' => 1, 'endYear' => true], 'type' => 'holidays'],
                ['from' => ['day' => 3, 'month' => 7, 'endYear' => true],
                    'to' => ['day' => 31, 'month' => 8, 'endYear' => true], 'type' => 'holidays']],
            4 => [
                ['from' => ['day' => 22, 'month' => 12, 'endYear' => false],
                    'to' => ['day' => 11, 'month' => 1, 'endYear' => true], 'type' => 'session'],
                ['from' => ['day' => 16, 'month' => 3, 'endYear' => true],
                    'to' => ['day' => 22, 'month' => 3, 'endYear' => true], 'type' => 'session'],
                ['from' => ['day' => 12, 'month' => 1, 'endYear' => true],
                    'to' => ['day' => 25, 'month' => 1, 'endYear' => true], 'type' => 'holidays']]
        ];
...
function getDateFromPeriod($dateInfo, $calendar)
{
    ...
    $date['month'] = $dateInfo['month'];
    $date['year'] = $dateInfo['endYear'] ? $calendar['endYear'] : $calendar['beginYear'];
    return $date;
}
